...
for (let i=-1; i>=-4 ;i--){
    ...
    console.log(`Dear ${removed} ,this is to inform you that you are not invited to the party.`);
}
guestList.forEach((val)=>console.log(`Dear honourable ${val} ,this to inform that you are still invited to the party.`))

guestList.pop()
guestList.pop()
guestList.forEach((val)=>console.log(`${val}`))
