...
for (var index = 0; index < Ordinal_number.length; index++) {
    if (Ordinal_number[index] === 1) {
        console.log("".concat(Ordinal_number[index], "st"));
    }
    else if (Ordinal_number[index] === 2) {
        console.log("".concat(Ordinal_number[index], "nd"));
    }
    else if (Ordinal_number[index] === 3) {
        console.log("".concat(Ordinal_number[index], "rd"));
    }
    else {
        console.log("".concat(Ordinal_number[index], "th"));
    }
}
